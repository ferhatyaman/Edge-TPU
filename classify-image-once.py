...
Example usage:
```
python3 classify-image-once.py \
  -m mnist_model_quant_edgetpu.tflite  \
  -c 1
```
"""
...
def main():
  ...
  labels = read_label_file("./mnist_labels.txt") if args.labels else {}
  ...
  #while 1:
  #input_image_name = "./testSample/img_"+ str(args.count) + ".jpg"
